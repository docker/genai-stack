...
After the activation enter into the WSL with teh command `wsl` and type `docker`.

2. Install ollama using https://github.com/jmorganca/ollama (avec la commande `curl https://ollama.ai/install.sh | sh`)
    ...
    ```
    - To remove model: `ollama rm llama2`
...
On MAC you can follow this tutoril: https://collabnix.com/getting-started-with-genai-stack-powered-with-docker-langchain-neo4j-and-ollama/